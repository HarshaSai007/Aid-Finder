				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu">
							...
							<ul>
								<li><a href="agencies-list.php">Agencies List</a></li>
							</ul>
						</li>
			...
			<div class="content container-fluid">
				...
				<div class="card flex-fill student-space comman-shadow">
					<div class="card-header d-flex align-items-center">
						<h5 class="card-title">Rescue Agencies Registraction Request</h5>
								...
								<tbody>
									...
									while ($row = $result->fetch_assoc()) {
										if ($row['reg_status'] == 0) {
											...
											echo ' </td>';
											// echo '<td class="text-center"><button class="btn btn-sm btn-outline-secondary" onclick="location(\'' . $row['a_lat'] . ', ' . $row['a_lon'] . '\')">Locate</button></td>';
											echo '<td>
											<button 
