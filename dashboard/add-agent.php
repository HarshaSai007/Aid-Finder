...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `users` (`name`,`mobile`, `pass`,`blood_grp`,`user_type`, `a_id`, `status`) values('$agent_name','$mobile','$pass', '$blood_grp','2','2','1')";
	$result = mysqli_query($con, $sql);

	$sql1 = "INSERT INTO `gps_track` (`track_time`) values('$time_stamp')";
						...
						<div class="card comman-shadow">
							<div class="card-body">
								<form method="post">
									<div class="row">
										<div class="col-12">
											<h5 class="form-title student-info">Agent Information <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
										</div>

										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												<label>Agent Name <span class="login-danger">*</span></label>
												<input class="form-control" name="agent_name" type="text" placeholder="Enter Your Name">
											</div>
										</div>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input class="form-control" name="blood_group" type="text" placeholder="Enter Your Blood Group">
											</div>
										</div>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input class="form-control" name="pass" type="password" placeholder="Enter Your Email">
											</div>
										</div>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												<label>Mobile </label>
												<input class="form-control" name="mobile" type="text" placeholder="Enter Phone Number">
											</div>
										</div>
										<div class="col-12">
